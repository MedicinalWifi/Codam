...
/*                                                                            */
/*                                                        ::::::::            */
/*   get_redundant_section_assignment.c                 :+:    :+:            */
/*                                                     +:+                    */
/*   By: lhop <lhop@student.codam.nl>                 +#+                     */
/*                                                   +#+                      */
/*   Created: 2022/12/08 12:44:31 by lhop          #+#    #+#                 */
/*   Updated: 2022/12/09 11:45:32 by lhop          ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int	get_redundant_section_assignments(char *text)
{
	...
	while (text[i] != '\n' && text[i + 1] != '\n')
	{
		...
		if (a1_start_section <= a2_start_section && a1_end_section >= a2_end_section)
			full_containment_count++;
		else if (a1_start_section >= a2_start_section && a1_end_section <= a2_end_section)
			full_containment_count++;
...
int main(void)
{
	...
	answer = get_redundant_section_assignments(text);
